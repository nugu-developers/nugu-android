...
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    val body by lazy { findViewById<ImageView>(R.id.tv_body) }
    val footer by lazy { findViewById<ImageView>(R.id.tv_footer) }

    init {
        setContentView(R.layout.view_item_weather_1)
    }
}