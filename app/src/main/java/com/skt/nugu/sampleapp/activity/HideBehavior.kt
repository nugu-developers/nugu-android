...
class HideBehavior @JvmOverloads constructor(context: Context? = null, attrs: AttributeSet? = null)
    ...
    override fun layoutDependsOn(parent: CoordinatorLayout, child: AppBarLayout, dependency: View): Boolean {
        if (parent.resources.configuration.orientation == ORIENTATION_LANDSCAPE) {
