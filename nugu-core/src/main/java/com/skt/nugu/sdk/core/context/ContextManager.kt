...
class ContextManager : ContextManagerInterface {
    ...
    private fun getCachedStateInfo(namespaceAndName: NamespaceAndName): StateInfo? = namespaceToNameStateInfo[namespaceAndName.namespace]?.getValue(namespaceAndName.name)
}
