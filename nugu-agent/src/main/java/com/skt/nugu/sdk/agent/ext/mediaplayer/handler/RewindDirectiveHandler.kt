...
class RewindDirectiveHandler(
    ...
    companion object {
        private const val TAG = "RewindDirectiveHandler"
    ...
    interface Controller {
        fun rewind(header: Header, payload: Payload, callback: EventCallback)
    }
    ...
    override fun handleDirective(info: DirectiveInfo) {
        ...
        if(payload == null) {
            ...
            controller.rewind(info.directive.header, payload, object:
                EventCallback {
    ...
    override fun getConfiguration(): Map<NamespaceAndName, BlockingPolicy> {
        ...
        configuration[REWIND] = BlockingPolicy(BlockingPolicy.MEDIUM_AUDIO)
