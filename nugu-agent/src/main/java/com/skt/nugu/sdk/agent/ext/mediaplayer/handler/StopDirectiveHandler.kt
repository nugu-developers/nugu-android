...
class StopDirectiveHandler(
    ...
    companion object {
        private const val TAG = "StopDirectiveHandler"
        private const val NAME_STOP = "Stop"
        private const val NAME_SUCCEEDED = "Succeeded"
        private const val NAME_FAILED = "Failed"

        private val PAUSE = NamespaceAndName(MediaPlayerAgent.NAMESPACE, NAME_STOP)
    }

    interface Controller {
        fun stop(header: Header, payload: Payload, callback: EventCallback)
    }
    ...
    override fun handleDirective(info: DirectiveInfo) {
        ...
        if(payload == null) {
            ...
            controller.stop(info.directive.header, payload, object:
                EventCallback {
    ...
    override fun getConfiguration(): Map<NamespaceAndName, BlockingPolicy> {
        ...
        configuration[PAUSE] = BlockingPolicy(BlockingPolicy.MEDIUM_AUDIO)
