...
interface SpeechRecognizer {
    ...
    fun start(audioInputStream: SharedDataStream, audioFormat: AudioFormat, context: String, wakeupInfo: WakeupInfo?, payload: ExpectSpeechPayload?, resultListener: ASRAgentInterface.OnResultListener?)
    fun stop()
